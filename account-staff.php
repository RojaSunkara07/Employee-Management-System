...
<html lang="en">
    <head>
        ...
        <title>CorpU &#8211; Staff &#8211; Account</title>
   ...
   <body>
        ...
        <header>
            <nav> 
                ...
                <ul>
                    ...
                    <li><a href="account-staff.php" id="select"><i class="ri-profile-line"></i><p>Account</p></a></li> 
        ...
        <div id="full-container">
            <section id="page-top">
                <h4 class="sub-header white-txt">YOU AS A CURRENT MENTOR</h4>
                <br>
                <p class="white-txt center">Staff profile</p>  
            </section>
