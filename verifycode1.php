...
<html lang="en">
	...
	<div class="signup-container"> 
            ...
            <div class="form-cube"> 
                ...
                <h1 id="heading"> Enter the verification code </h1>
		<div class="input-field" id="idFld"> 
                             <!-- HTML validation -->
                            <input type="text" name="Verificationcode" id="verificationcode" required="required" placeholder="Verification Code"> 
                        </div>
		<div id="float-right">
                             <!-- Form button that submits input to backend -->
                            <button id="fill" type="submit" value="submit" class="signinBttn">Verify</button>
                        </div>
